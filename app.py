...
def uploaded_file(filename):
    thum = qrgenerator.create_qrcode(request.args.get('text'), os.path.dirname(os.path.abspath(__file__)) + '/static/'+filename, request.args.get('newversion'))
    return send_from_directory(os.path.dirname(os.path.abspath(__file__)) + '/static/', filename+'qr.jpg')
